...
var EmulatedEncapsulationServerRendererV2 = function (_DefaultServerRendere) {
    ...
    function EmulatedEncapsulationServerRendererV2(document, ngZone, sharedStylesHost, schema, component) {
        ...
        _this7.contentAttr = ɵshimContentAttribute(component.id);
        _this7.hostAttr = ɵshimHostAttribute(component.id);
        return _this7;
    }
    /**
     * @param {?} element
...
var ServerStylesHost = function (_SharedStylesHost) {
    ...
    function ServerStylesHost(doc, transitionId) {
        ...
        _this8.head = null;
        _this8.head = ɵgetDOM().getElementsByTagName(doc, 'head')[0];
        return _this8;
    }
    /**
     * @param {?} style
...
ServerModule.decorators = [{ type: NgModule, args: [{
        ...
        imports: [HttpModule],
        providers: [SERVER_RENDER_PROVIDERS, SERVER_HTTP_PROVIDERS, { provide: Testability, useValue: null }]
    }] }];
/** @nocollapse */
