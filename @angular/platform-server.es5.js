 ...
 */function appendNodes(parent,nodes){for(var/** @type {?} */i=0;i<nodes.length;i++){ɵgetDOM().appendChild(parent,nodes[i]);}}var ServerRendererFactoryV2=function(){/**
     ...
     * @param {?} ngZone
     * @param {?} schema
     */function DefaultServerRendererV2(document,ngZone,schema){_classCallCheck(this,DefaultServerRendererV2);this.document=document;this.ngZone=ngZone;this.schema=schema;}/**
     * @return {?}
