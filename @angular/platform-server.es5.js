 ...
 */var Parse5DomAdapter=function(_DomAdapter){_inherits(Parse5DomAdapter,_DomAdapter);function Parse5DomAdapter(){_classCallCheck(this,Parse5DomAdapter);return _possibleConstructorReturn(this,(Parse5DomAdapter.__proto__||Object.getPrototypeOf(Parse5DomAdapter)).apply(this,arguments));}_createClass(Parse5DomAdapter,[{key:'hasProperty',/**
     ...
     * @param {?} selector
     * @return {?}
     */value:function querySelector(el,selector){return this.querySelectorAll(el,selector)[0]||null;}/**
     * @param {?} el
     * @param {?} selector
     * @return {?}
 ...
 *
 * \@experimental
 */var ServerModule=function ServerModule(){_classCallCheck(this,ServerModule);};ServerModule.decorators=[{type:NgModule,args:[{exports:[BrowserModule],imports:[HttpModule],providers:[SERVER_RENDER_PROVIDERS,SERVER_HTTP_PROVIDERS,{provide:Testability,useValue:null}]}]}];/** @nocollapse */ServerModule.ctorParameters=function(){return[];};/**
 * @param {?} injector
 * @return {?}
