...
/**
     ...
     */var a=r.createPlatformFactory(n.ɵplatformCoreDynamicTesting,"serverTesting",t.ɵINTERNAL_SERVER_PLATFORM_PROVIDERS),i=function(){function e(){}return e.ngModuleDef=r.ɵdefineNgModule({type:e,bootstrap:[],declarations:[],imports:[o.NoopAnimationsModule],exports:[n.BrowserDynamicTestingModule]}),e.ngInjectorDef=r.defineInjector({factory:function r(n){return new(n||e)},providers:t.ɵSERVER_RENDER_PROVIDERS,imports:[[o.NoopAnimationsModule],[n.BrowserDynamicTestingModule]]}),e}();
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
