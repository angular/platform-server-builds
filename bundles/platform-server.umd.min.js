 ...
 * License: MIT
 */
!function(global,factory){"object"==typeof exports&&"undefined"!=typeof module?factory(exports,require("@angular/core"),require("@angular/platform-browser"),require("@angular/common"),require("@angular/compiler"),require("@angular/http"),require("rxjs/Observable"),require("rxjs/Subject"),require("url"),require("rxjs/operator/filter"),require("rxjs/operator/first"),require("rxjs/operator/toPromise")):"function"==typeof define&&define.amd?define(["exports","@angular/core","@angular/platform-browser","@angular/common","@angular/compiler","@angular/http","rxjs/Observable","rxjs/Subject","url","rxjs/operator/filter","rxjs/operator/first","rxjs/operator/toPromise"],factory):factory((global.ng=global.ng||{},global.ng.platformServer=global.ng.platformServer||{}),global.ng.core,global.ng.platformBrowser,global.ng.common,global.ng.compiler,global._angular_http,global.rxjs_Observable,global.rxjs_Subject,global.url,global.rxjs_operator_filter,global.rxjs_operator_first,global.rxjs_operator_toPromise)}(this,function(exports,_angular_core,_angular_platformBrowser,_angular_common,_angular_compiler,_angular_http,rxjs_Observable,rxjs_Subject,url,rxjs_operator_filter,rxjs_operator_first,rxjs_operator_toPromise){"use strict";function httpFactory(xhrBackend,options){var macroBackend=new ZoneMacroTaskBackend(xhrBackend);return new _angular_http.Http(macroBackend,options)}function scheduleMicroTask(fn){Zone.current.scheduleMicroTask("scheduleMicrotask",fn)}function isPresent(obj){return null!=obj}function isBlank(obj){return null==obj}function stringify(token){if("string"==typeof token)return token;if(null==token)return""+token;if(token.overriddenName)return""+token.overriddenName;if(token.name)return""+token.name;var res=token.toString(),newLineIndex=res.indexOf("\n");return newLineIndex===-1?res:res.substring(0,newLineIndex)}function setValueOnPath(global,path,value){for(var parts=path.split("."),obj=global;parts.length>1;){var name_1=parts.shift();obj=obj.hasOwnProperty(name_1)&&null!=obj[name_1]?obj[name_1]:obj[name_1]={}}void 0!==obj&&null!==obj||(obj={}),obj[parts.shift()]=value}function parseUrl(urlStr){var parsedUrl=url.parse(urlStr);return{pathname:parsedUrl.pathname||"",search:parsedUrl.search||"",hash:parsedUrl.hash||""}}function _notImplemented(methodName){return new Error("This method is not implemented in Parse5DomAdapter: "+methodName)}function parseDocument(html){return parse5$1.parse(html,{treeAdapter:parse5$1.treeAdapters.htmlparser2})}function moveNodesAfterSibling(ref,nodes){var parent=getDOM().parentElement(ref);if(nodes.length>0&&parent){var nextSibling=getDOM().nextSibling(ref);if(nextSibling)for(var i=0;i<nodes.length;i++)getDOM().insertBefore(parent,nextSibling,nodes[i]);else for(var i=0;i<nodes.length;i++)getDOM().appendChild(parent,nodes[i])}}function appendNodes(parent,nodes){for(var i=0;i<nodes.length;i++)getDOM().appendChild(parent,nodes[i])}function initParse5Adapter(injector){return function(){Parse5DomAdapter.makeCurrent()}}function _createConditionalRootRenderer(rootRenderer){return _angular_core.isDevMode()?new DebugDomRootRenderer(rootRenderer):rootRenderer}function _addStylesToRootComponentFactory(stylesHost){var initializer=function(){return stylesHost.rootComponentIsReady()};return initializer}function _document(injector){var config=injector.get(INITIAL_CONFIG,null);return config&&config.document?parseDocument(config.document):getDOM().createHtmlDocument()}function _getPlatform(platformFactory,options){var extraProviders=options.extraProviders?options.extraProviders:[];return platformFactory([{provide:INITIAL_CONFIG,useValue:{document:options.document,url:options.url}},extraProviders])}function _render(platform,moduleRefPromise){return moduleRefPromise.then(function(moduleRef){var applicationRef=moduleRef.injector.get(_angular_core.ApplicationRef);return rxjs_operator_toPromise.toPromise.call(rxjs_operator_first.first.call(rxjs_operator_filter.filter.call(applicationRef.isStable,function(isStable){return isStable}))).then(function(){var output=platform.injector.get(PlatformState).renderToString();return platform.destroy(),output})})}function renderModule(module,options){var platform=_getPlatform(platformDynamicServer,options);return _render(platform,platform.bootstrapModule(module))}function renderModuleFactory(moduleFactory,options){var platform=_getPlatform(platformServer,options);return _render(platform,platform.bootstrapModuleFactory(moduleFactory))}var DomAdapter=_angular_platformBrowser.__platform_browser_private__.DomAdapter,setRootDomAdapter=_angular_platformBrowser.__platform_browser_private__.setRootDomAdapter,getDOM=_angular_platformBrowser.__platform_browser_private__.getDOM,SharedStylesHost=_angular_platformBrowser.__platform_browser_private__.SharedStylesHost,NAMESPACE_URIS=_angular_platformBrowser.__platform_browser_private__.NAMESPACE_URIS,shimContentAttribute=_angular_platformBrowser.__platform_browser_private__.shimContentAttribute,shimHostAttribute=_angular_platformBrowser.__platform_browser_private__.shimHostAttribute,flattenStyles=_angular_platformBrowser.__platform_browser_private__.flattenStyles,splitNamespace=_angular_platformBrowser.__platform_browser_private__.splitNamespace,isNamespaced=_angular_platformBrowser.__platform_browser_private__.isNamespaced,PlatformState=(require("parse5"),function(){function PlatformState(_doc){this._doc=_doc}return PlatformState.prototype.renderToString=function(){return getDOM().getInnerHTML(this._doc)},PlatformState.prototype.getDocument=function(){return this._doc},PlatformState}());PlatformState.decorators=[{type:_angular_core.Injectable}],PlatformState.ctorParameters=function(){return[{type:void 0,decorators:[{type:_angular_core.Inject,args:[_angular_platformBrowser.DOCUMENT]}]}]};/**
     * @license
