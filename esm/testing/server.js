import { APP_ID, NgZone, PLATFORM_COMMON_PROVIDERS, PLATFORM_INITIALIZER, APPLICATION_COMMON_PROVIDERS, RootRenderer } from '@angular/core';
import { DirectiveResolver, ViewResolver, XHR, COMPILER_PROVIDERS } from '@angular/compiler';
import { TestComponentBuilder, MockDirectiveResolver, MockViewResolver, TestComponentRenderer } from '@angular/compiler/testing';
