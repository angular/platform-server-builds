 ...
 */
import { AppModule, OpaqueToken, PLATFORM_COMMON_PROVIDERS, PLATFORM_INITIALIZER, ReflectiveInjector, assertPlatform, createPlatform, getPlatform } from '@angular/core';
...
const TEST_SERVER_PLATFORM_PROVIDERS = 
/*@ts2dart_const*/ [
 ...
 */
export function serverTestPlatform() {
    if (!getPlatform()) {
